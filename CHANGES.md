- Unreleased - restore type-aware Variant payload ownership; move single-recipient calls directly, recursively clone ARC/ORC thread fanout, retain references for local queues and Atomic ARC, and traverse subscription fanout once using an owned lookahead
