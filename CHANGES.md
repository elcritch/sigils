- Unreleased - speed up emission to a sole direct local slot by borrowing its subscription for the call; retain endpoint liveness checks and the existing snapshots for actors, proxies, and fanout
