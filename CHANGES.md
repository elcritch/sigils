...
- Unreleased - move transport-independent RPC routing and the main JSON-RPC interface into `sigils/rpcs`, add import-driven `jr*` transport modules, and provide newline-delimited TCP wiring for local selector, selector helper, and Chronos helper schedulers
